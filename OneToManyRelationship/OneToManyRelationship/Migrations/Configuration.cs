...
namespace OneToManyRelationship.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<OneToManyRelationship.Context.ProjectDbContext>
    {
        ...
        protected override void Seed(OneToManyRelationship.Context.ProjectDbContext context)
        {
