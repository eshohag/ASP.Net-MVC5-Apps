...
using OneToManyRelationship.Context;
...
namespace OneToManyRelationship.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Email,Address,DepartmentId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Email,Address,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
